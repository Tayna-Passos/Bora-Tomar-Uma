...
function createProductCard(product) {
    // Lógica para detectar se a página atual está em uma subpasta
    ...
    // Ajusta o caminho da imagem: se estiver em pasta, volta um nível (../)
    const correctImgPath = isSubfolder ? "../" + product.img : "./" + product.img;

    return `
        <article class="product-card" data-id="${product.id}">
            <img src="${correctImgPath}" alt="${product.name}">
